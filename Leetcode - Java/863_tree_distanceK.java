...
class Solution {
    ...
    public void populateNodeToParentMap(Map<TreeNode, TreeNode> nodeToParentMap, TreeNode root, TreeNode parent) {
        if (root == null) return;
    ...
    public List<Integer> extractLayerFromQueue(Queue<TreeNode> queue) {
